...
const { RiTruckFill, FaTty, BsReplyFill, AiFillGift, BsShieldShaded } = icons;
export const productExtraInfomation = [
  {
    id: 1,
    title: 'Guarantee',
    sub: 'Quality Checked',
    icon: <BsShieldShaded color="white" />,
  },
  {
    id: 2,
    title: 'Free Shipping',
    sub: 'Free On All Products',
    icon: <RiTruckFill color="white" />,
  },
  {
    id: 3,
    title: 'Special Gift Cards',
    sub: 'Special Gift Cards',
    icon: <AiFillGift color="white" />,
  },
  {
    id: 4,
    title: 'Free Return',
    sub: 'Within 7 Days',
    icon: <BsReplyFill color="white" />,
  },
  {
    id: 5,
    title: 'Consultancy',
    sub: 'Lifetime 24/7/356',
    icon: <FaTty color="white" />,
  },
];
...
const { AiOutlineDashboard, MdGroups, RiProductHuntFill, RiBillLine } = icons;
...
export const ourServices = [
  {
    id: 1,
    title: 'Address: 474 Ontario St Toronto, ON M4X 1M7 Canada',
    icon: <BsShieldShaded color="white" />,
  },
  {
    id: 2,
